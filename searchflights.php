...
<div class="main">
    <div class="sidenav">
        ...
        <a href="homepage.php"><button type="button" class="btn btn-danger btn-sm" style="float:right">LOGOUT</button></a>
        <a href="customer_enqi.html"><button type="button" class="btn btn-success btn-sm" style="float:right">MAKE AN ENQUIRY</button></a>
      </div>
      <nav id="side">
        <ul>
          <br>
      ...
      <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTB5nWJeJStVSln4FEFOjNFF-AWjHE7OhgvYTu4mXG9xQdekA34VR3RXu0o7PJn3EEEJjo&usqp=CAU" style="width: 50px;"id="menu">
    <div class="testbox">
    <form action="/flight_management/searchflights.html" method="post">
      <!--<div class="banner">
      </div>-->
      <div class="item">
            <label for="fcity">FROM:</label>
...
>>>>>>> 022aefa40ded7691d6403652d2cfe8b8846b9233
